...
class Meta(nn.Module):
    ...
    def __init__(self, lr, lr_update, step_update, test_step_update, num_graph, config):

        super(Meta, self).__init__()

        self.update_lr = lr_update
        self.meta_lr = lr
        self.task_num = num_graph - 1
        self.update_step = step_update
        self.update_step_test = test_step_update
