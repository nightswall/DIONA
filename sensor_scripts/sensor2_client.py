...
# Function to generate a random pressure reading
def generate_reading():
    return random.uniform(1000, 1100)

# Function to send the pressure reading to the MQTT broker
...
# Generate and send a random pressure reading every 5 seconds
while True:
